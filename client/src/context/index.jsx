...
//       mode: saved.theme?.mode || "light",
//       paletteKey: saved.theme?.paletteKey || DEFAULT_PALETTE_KEY,
//       custom: saved.theme?.custom || {}, // { iconColor?, text?, shadowColor? }
//     },
//   };
...
//       "app_theme_state",
//       JSON.stringify({ theme: controller.theme })
//     );
//   }, [controller.theme]);
...
// // ---- new setters ----
// export const setThemeMode = (dispatch, value) => dispatch({ type: "THEME_MODE", value }); // "light" | "dark"
// export const setThemePalette = (dispatch, value) => dispatch({ type: "THEME_PALETTE", value }); // e.g. "blue"
// export const setThemeCustom = (dispatch, custom) => dispatch({ type: "THEME_CUSTOM", value: custom }); // {iconColor?, text?, shadowColor?}
