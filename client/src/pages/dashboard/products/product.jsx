...
export function Product() {
  ...
  const [resetForm, setResetForm] = useState(null); // 🔑 yaha reset store hoga
  ...
  const handleSubmit = async (data) => {
    try {
      ...
      toggleModal();
       if (resetForm) resetForm(); // ✅ ab kaam karega


      return true; // success return karega
    } catch (err) {
      ...
      return false; // failure return karega
    }
  };
